...
class Mealy:    # mealy machine을 정의
    ...
    def display_hangul(self, sigma):    # 한글 모아쓰기 출력 함수; result()함수를 기반으로 한글 유니코드 계산에 대한 부분이 추가 되었음
        ...
        for i in sigma:
            ...
            last_table_temp = {30 : 9, 31 : 11, 32 : 2, 33 : 3, 34 : 11}
            ...
            for o in self.out_function:
                if o[0][0] == current and o[0][1] == i:
                    ...
                    if current_loc == 0 and not fin: ## 초성
                        if o[1] != 100 and o[1] != 99:
                            first = o[1]
                        elif o[1] == 100:  ## 획추가
                    ...
                    elif current_loc == 2 and not fin: ## 종성
                        if last == -1:
                            last = o[1]
                        elif o[1] == 100:
                    ...
                    if current_loc == 0:
                        ...
                        if last != 30 and last != 31 and last != 32 and last != 33 and last != 34:
                            ...
                            code_value_temp = last_table_temp[last]
                    ...
                    if last != 30 and last != 31 and last != 32 and last != 33 and last != 34:
                        ...
                        for i in result:
                            print(i, end='')
                        print(chr(code_value), end='')
                        print(chr(ord(jaeum_table[code_value_temp])) + ' ', end = '')
